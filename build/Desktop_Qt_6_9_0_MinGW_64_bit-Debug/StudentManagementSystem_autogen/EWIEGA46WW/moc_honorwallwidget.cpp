...
namespace {
struct qt_meta_tag_ZN15HonorWallWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto HonorWallWidget::qt_create_metaobjectdata<qt_meta_tag_ZN15HonorWallWidgetE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "HonorWallWidget"
    ...
    return QtMocHelpers::metaObjectData<HonorWallWidget, qt_meta_tag_ZN15HonorWallWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject HonorWallWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15HonorWallWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15HonorWallWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15HonorWallWidgetE_t>.metaTypes,
    nullptr
} };

void HonorWallWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<HonorWallWidget *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15HonorWallWidgetE_t>.strings))
        return static_cast<void*>(this);
